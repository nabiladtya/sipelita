        ...
        <div class="row text-center mt-5 mb-5">
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="p-4 bg-success text-white rounded">
                    ...
                    <hr>
                    <h5 class="count" data-target="<?php echo $total_pending; ?>"></h5> <!-- Angka akan mulai dari 0 -->
                </div>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="p-4 bg-primary text-white rounded">
                    ...
                    <hr>
                    <h5 class="count" data-target="<?php echo $total_approved; ?>"></h5> <!-- Angka akan mulai dari 0 -->
                </div>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="p-4 bg-danger text-white rounded">
                    ...
                    <hr>
                    <h5 class="count" data-target="<?php echo $total_rejected; ?>"></h5> <!-- Angka akan mulai dari 0 -->
                </div>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.count').each(function() {
                    ...
                    var count = 0;
                    var speed = 50; // Adjust speed (in ms)
